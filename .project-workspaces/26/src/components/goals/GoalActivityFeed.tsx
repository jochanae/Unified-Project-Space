...
const activityIcons: Record<string, React.ReactNode> = {
  goal_created: <Target className="h-4 w-4 text-green-500" />,
  contribution_added: <DollarSign className="h-4 w-4 text-blue-500" />,
  contribution_approved: <CheckCircle className="h-4 w-4 text-green-500" />,
  collaborator_joined: <UserPlus className="h-4 w-4 text-purple-500" />,
  collaborator_left: <UserMinus className="h-4 w-4 text-red-500" />,
  goal_updated: <Edit className="h-4 w-4 text-yellow-500" />,
  comment_added: <MessageCircle className="h-4 w-4 text-blue-400" />,
  milestone_reached: <CheckCircle className="h-4 w-4 text-green-500" />,
};

const activityColors: Record<string, string> = {
  goal_created: "bg-green-100 border-green-200",
  contribution_added: "bg-blue-100 border-blue-200",
  contribution_approved: "bg-green-100 border-green-200",
  collaborator_joined: "bg-purple-100 border-purple-200",
  collaborator_left: "bg-red-100 border-red-200",
  goal_updated: "bg-yellow-100 border-yellow-200",
  comment_added: "bg-blue-50 border-blue-200",
  milestone_reached: "bg-green-100 border-green-200",
};

const GoalActivityFeed = ({ goalId }: GoalActivityFeedProps) => {
                  ...
                  {dateActivities.map((activity, index) => (
                    <div key={activity.id} className="relative flex gap-3">
                      ...
                      <div className="flex-1 min-w-0 pb-2">
                        ...
                        {/* Metadata display */}
                        {activity.metadata && activity.activity_type === "contribution_added" && (
...
export default GoalActivityFeed;
