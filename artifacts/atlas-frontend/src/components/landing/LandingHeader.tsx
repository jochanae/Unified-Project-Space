  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        <svg width="32" height="32" viewBox="0 0 512 512" display="block" style={{ flexShrink: 0, borderRadius: "50%" }} aria-hidden>
          <defs>
            <radialGradient id="lpmpg" cx="50%" cy="50%" r="50%">
              <stop offset="0%" stopColor="#5B21B6" stopOpacity="0.35" />
              <stop offset="100%" stopColor="#0D0B09" stopOpacity="0" />
            </radialGradient>
            <radialGradient id="lpmgs" cx="50%" cy="40%" r="50%">
          ...
          <circle cx="256" cy="256" r="256" fill="url(#lpmpg)" />
          <polygon points="256,130 178,390 216,390 268,188" fill="url(#lpmgs)" />
          <polygon points="256,130 334,390 296,390 244,188" fill="url(#lpmgs)" />
          <rect x="192" y="292" width="128" height="30" rx="5" fill="url(#lpmgs)" />
        </svg>
        <span style={{
          ...smallUiText,
