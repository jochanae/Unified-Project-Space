...
import { Session, createEntry, updateEntry, deleteEntry, Project } from "@workspace/api-client-react";
import { useEntryReferrer } from "@/hooks/useEntryReferrer";
import { useLocation } from "wouter";
import { useListProjects, useListEntries, useCreateEntry, useUpdateEntry, useDeleteEntry, useListSessions, useGetSession, getListEntriesQueryKey, getListSessionsQueryKey, getGetSessionQueryKey } from "@workspace/api-client-react";
import { useQueryClient } from "@tanstack/react-query";

type Tool = "decision-editor" | "diff-review" | "session-exporter" | "bulk-import";
const SHELL_TOOLS = new Set<Tool>(["diff-review", "session-exporter", "bulk-import"]);
